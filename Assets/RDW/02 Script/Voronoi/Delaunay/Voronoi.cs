...
namespace csDelaunay {
	...
	public class Voronoi {
		...
		public Vector2f GetCentroidTwin(int index, bool FirstOne, ref float shape)
		{
			Site site = sites.GetSite_byIndex(index);

			// Loop all corners of the site to calculate the centroid
			List<Vector2f> region = site.RegionTwin(plotBounds, FirstOne);
		...
		public (Vector2f, List<Vector2f>) GetCentroidTwin_region(int index, bool FirstOne, ref float shape)
		{
			Site site = sites.GetSite_byIndex(index);
		...
		public List<Vector2f> GetCentroid(int polygonNum, ref List<float> list_area)
		{
			List<Vector2f> newPoints = new List<Vector2f>();
			// Go thourgh all sites
			//sites.ResetListIndex();
			...
			{
				Site site = sites.GetSite_byIndex(i);
		...
		public List<Vector2f> GetCentroid_site(int polygonNum, ref List<float> list_area, ref SiteList _sites)
		{
			List<Vector2f> newPoints = new List<Vector2f>();
			// Go thourgh all sites
			//sites.ResetListIndex();
